...
forks** of the Applicant design system:
...
- **applicant** — additional MIT-licensed design-system modules from the same UI
  ...
  surfaces need. Licensed **MIT**, Copyright (c) 2025 Applicant Contributors.

The MIT `LICENSE` from the applicant fork is preserved verbatim at
...
distribute. The vendored UI is now MIT (owner's applicant/applicant forks) and
