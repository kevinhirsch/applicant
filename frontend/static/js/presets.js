  ...
  if (delBtn) {
    delBtn.addEventListener('click', async () => {
      ...
      try {
        ...
        if (isBuiltin) {
          const hidden = loadStoredArray('applicant-hidden-presets');
...
function _populateCharSelect() {
  ...
  const hiddenPresets = loadStoredArray('applicant-hidden-presets');
...
function initPersistentChat() {
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      const charSessions = loadStoredObject('applicant-char-sessions');
