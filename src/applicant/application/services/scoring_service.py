...
class ScoringService:
    ...
    def _llm_base(
        ...
        system_text = (
            ...
            "penalty. This CONFIRMED-remote verdict holds EVEN IF the employer is "
            "a federal/government agency or a consulting firm, and EVEN IF the "
            "role requires travel to client, plant, or customer sites: an "
            "explicitly-remote base that travels is still remote, and a routine "
            "background check or a low-level Public Trust is NOT a disqualifier. "
            "(2) Otherwise, if a specific city/region is named ANYWHERE "
            ...
            "or an actually-STATED hard security clearance (TS/SCI, Secret) with "
            "no accompanying remote statement is present, "
            ...
            "says 'onsite'. But a client/plant/customer site a remote-based role "
            "merely TRAVELS to is NOT the role's own work location: never treat "
            "'extensive travel', 'travel required', or named travel destinations "
            "as an onsite signal, and never INFER a clearance or an onsite "
            "requirement merely because the employer is federal or government — "
            "an explicit remote statement always wins over such an inference. "
            "(3) ONLY when NEITHER of the above applies — truly no "
