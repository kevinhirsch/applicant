...
# any Python file in the workspace. GREEN: prove nothing imports the package today.
# @pending: the cleanup acceptance criterion — the dead package has been removed.
