...
# subprocesses and never import it. GREEN: prove no MCP server imports the helper.
# @pending: the cleanup acceptance criterion — the orphaned helper has been removed.
