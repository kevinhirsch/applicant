"""scripts/_lib/cli.py — shared scaffolding for the `applicant-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("applicant-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/applicant-foo`
...
VERSION = "0.1.0"  # bumped centrally; every applicant-* CLI reports this
