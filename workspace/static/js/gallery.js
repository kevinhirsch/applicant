  ...
  detail.innerHTML = `
    ...
    <div class="gallery-detail-body">
      ...
      <div class="gallery-detail-sidebar">
        ...
        ${img.gps ? `<div class="gallery-detail-section"><label>Location</label><div>${_esc(String(img.gps.lat))}, ${_esc(String(img.gps.lng))}</div></div>` : ''}
...
export function openGallery() {
  ...
  function _showGalleryBulkMenu(anchor) {
    ...
    // Standard Applicant dropdown (.dropdown + dropdown-item-compact) so it
